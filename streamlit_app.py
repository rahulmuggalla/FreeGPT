...
st.set_page_config(
    page_title="Talk with Anything 💬", page_icon="🤗", layout="wide", initial_sidebar_state="expanded"
)
            ...
            if st.button('Login 🚀') and hf_email and hf_pass and hf_token: 
                with st.spinner('🚀 Logging in...'):
                    ...
                    if 'generated' not in st.session_state:
                        st.session_state['generated'] = ["I'm your** Personal Assistant**, How may I help you ? "]
...
# END OF PLUGIN
    ...
    st.write('Made with ❤️ by Muggalla Rahul')
